...
/* harmony export */ });
/* harmony import */ var C_Users_cuent_Desktop_DAH_UNIDAD1_eje02_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator */ 2783);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,C_Users_cuent_Desktop_DAH_UNIDAD1_eje02_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    if (delegate) {
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,C_Users_cuent_Desktop_DAH_UNIDAD1_eje02_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,C_Users_cuent_Desktop_DAH_UNIDAD1_eje02_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
...
/* harmony import */ var _C_Users_cuent_Desktop_DAH_UNIDAD1_eje02_node_modules_ngtools_webpack_src_loaders_direct_resource_js_explore_container_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./explore-container.component.html */ 9651);
...
ExploreContainerComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.Component)({
        ...
        template: _C_Users_cuent_Desktop_DAH_UNIDAD1_eje02_node_modules_ngtools_webpack_src_loaders_direct_resource_js_explore_container_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "TaskserviceService": () => (/* binding */ TaskserviceService)
/* harmony export */ });
...
TaskserviceService = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("<div id=\"container\">\n  <strong>{{ name }}</strong>\n  <ion-row>\n    <ion-col>\n        <ion-list>\n        <ion-item *ngIf=\"name == 'Todas las tareas'\" >\n            <ion-input [(ngModel)]=\"todoValue\"  placeholder=\"Nombre de la tarea\"></ion-input>\n            <ion-fab-button (click)=\"addTodo()\" *ngIf=\"todoValue != ''\">\n                <ion-icon name=\"add\"></ion-icon>\n              </ion-fab-button>\n        </ion-item>\n        <ion-col *ngIf=\"name == 'Todas las tareas'\">\n            <ion-item *ngFor=\"let item of tareas;let indice=index\" >\n                <ion-label>{{item}}</ion-label>\n                <ion-fab-button (click)=\"markASCompleted(indice)\" *ngIf=\"name == 'Todas las tareas'\"  color=\"success\" vertical=\"top\" horizontal=\"end\" >\n                  <ion-icon name=\"checkmark-outline\"></ion-icon>\n              </ion-fab-button>              \n                <ion-fab-button color=\"danger\" (click)=\"removeTodo(indice)\" vertical=\"top\" horizontal=\"end\">\n                    <ion-icon name=\"trash\"></ion-icon>\n                </ion-fab-button>\n            </ion-item>\n        </ion-col>            \n        <ion-col *ngIf=\"name != 'Todas las tareas'\">\n            <ion-item *ngFor=\"let item of tareasCompletas;let indice=index\" >\n                <ion-label>{{item}}</ion-label>\n                <ion-fab-button (click)=\"markASCompleted(indice)\" color=\"warning\" vertical=\"top\" horizontal=\"end\" >\n                  <ion-icon name=\"checkmark-outline\"></ion-icon>\n              </ion-fab-button>              \n                <ion-fab-button color=\"danger\" (click)=\"removeTodo(indice)\" vertical=\"top\" horizontal=\"end\">\n                    <ion-icon name=\"trash\"></ion-icon>\n                </ion-fab-button>\n            </ion-item>\n        </ion-col>                    \n        </ion-list>\n    </ion-col>\n</ion-row>\n</div>");
